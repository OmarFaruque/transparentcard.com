...
<div class="nbd-upload-inner">
    <h2><?php _e('Design hochladen', 'web-to-print-online-designer'); ?></h2>
    <?php
    ...
    <div class="nbu-upload-zone">
        ...
        <label for="nbd-file-upload">
            ...
            <span style="margin-bottom: 10px; margin-top: 10px;"><?php _e('Datei hier ablegen oder auswählen', 'web-to-print-online-designer'); ?></span>
