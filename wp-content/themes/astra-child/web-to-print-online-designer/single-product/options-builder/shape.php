    ...
    <div class="nbd-field-content">
        <div>
            ...
            <div class="nbo-ad-result">
                <span class="nbo-ad-result-shape omar-shape" ng-bind-html="nbd_fields['<?php echo $field['id']; ?>'].shape | svg_trusted"></span>
            ...
            <div class="shape-o-1 nbo-ad-pseudo-list <?php if( $sublist_position == 'r' ) echo 'nbo-ad-right'; ?>">
                <?php 
                    foreach ($field['general']['attributes']["options"] as $key => $attr):
                ?>
