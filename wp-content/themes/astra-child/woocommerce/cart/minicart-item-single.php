        ...
        <div class="qty-metas">
            ...
            <div class="transparentcard-qty-price-metas">
                <div class="price d-flex">
                    <div class="flex-1"><?php _e('Price per unit', 'transparentcard'); ?></div> 
                    <div class="flex-1">
                ...
                <div class="qty d-flex">
                    <div class="flex-1"><?php esc_attr_e( 'Quantity', 'transparentcard' ); ?></div>
                    <div class="flex-1">
                ...
                <div class="totalPrice d-flex">
                    <div class="flex-1"><?php esc_attr_e( 'Total Price', 'transparentcard' ); ?></div>
                    <div class="flex-1">
