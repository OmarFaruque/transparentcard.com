...
<div class="nbd-field-header">
    ...
    <?php if( $field['general']['description'] != '' ): ?>
        ...
        <span class="tooltip custom" data-tooltip-content="#tooltip_header_content<?php echo $field['id']; ?>"></span>
    <?php endif; ?>
...
<?php if(isset($field['general']['description']) && $field['general']['description'] != ''): ?>
    <div class="tooltip_templates">
        <span id="tooltip_header_content<?php echo $field['id']; ?>" style="margin-bottom:0;">
            <?php echo $field['general']['description']; ?>
        </span>
    </div>
<?php endif; ?>