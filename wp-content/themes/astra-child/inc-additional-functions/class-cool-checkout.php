            ...
            <div class="woocommerce-billing-fields">
              <form method="post" class="<?php echo !empty($validation) && (isset($_POST['billing_email']) || !is_checkout()) ? 'd-block': 'd-none'; ?> woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
                 ...
                 <div class="d-flex gap-10">
                    ...
                    <div class="flex-1">
                        <?php woocommerce_form_field( 'billing_last_name', array( 'type' => 'text', 'label' => esc_attr__( 'Last Name', 'transparentcards' ), 'required' => 0, 'class' => ['last-name']), $_POST['billing_last_name'] ?? '' ); ?>
                    </div>
                 </div>
                <div class="d-flex gap-10">
                <div class="flex-1">       
                ...
                <div class="d-flex gap-10">
                    <div class="flex-1">
                        <?php woocommerce_form_field( 'billing_phone', array('type' => 'tel', 'label' => __('Telephone', 'transparentcards')), $_POST['billing_phone'] ?? '' ); ?>
                    </div>
                    <div class="flex-1">
