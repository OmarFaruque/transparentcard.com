...
if( $_enable_upload_without_design ){
    $label = apply_filters( 'nbd_upload_design_label', esc_html__( 'Design hochladen', 'web-to-print-online-designer' ) );
}else{
        ...
        <div class="nbd-action-wrap">
            <?php if( $_enable_upload ): ?>
                ...
                <a class="button alt nbdesign-button upload-design" id="startUpload" style="display:none;">
                    ...
                    <span><?php esc_html_e( 'Design hochladen', 'web-to-print-online-designer' ); ?></span>
                </a>
            <?php endif; ?>
