...
<style>
    ...
    .nbo-delivery .nbd-help-tip::after,
    .nbd-field-header .nbd-help-tip::after{
        font-size: 12px;
    }
    .nbo-delivery .nbd-help-tip,
    ...
    .nbd-actions-wrap{flex-direction: column;}
    .nbd-field-content {
        padding: 10px 0;
    }   
    .nbd-action-wrap {
    ...
    .nbdq-add-a-quote button{padding: 12px;}
    ...
    .nbo-delivery-wrapper table td:first-child {
        background: white;
    }
    .nbd-field-content .nbd-radio,
    .nbd-label-wrap{
        display: flex;
        padding: 20px;
...
/*         width: -webkit-max-content;
    ...
    .nbd-xlabel-wrap > label:before{
        box-shadow: 5px 5px 0.5rem #aaa;
        content: '';
    ...
    .nbd-xlabel-wrap:hover > label:before {
        box-shadow: 5px 5px 1rem #555;
    }
    ...
    div.nbd-popup .nbd-field-header{
        /* margin-top: 10px; */
    }
    .nbd-popup .woocommerce-product-details__short-description {
        margin-bottom: 30px;
    }
    .ausrichtung .nbd-xlabel-wrapper {
        display: flex;
        flex-direction: row-reverse;
    }
    .nbd-option-field.count_4,
    .nbd-option-field.count_5,
    .nbd-option-field.count_6 {
        margin-bottom: 4.5em;
    }

    .nbd-field-header:before {
    content: '';
...
.nbo-delivery.ng-scope > p:before {
    content: '';
    position: absolute!important;
    width: 100px!important;
    height: 5px!important;
...
tr:not(.disabled) .nbo-delivery-date-selector:hover {
    background: #5aabbe !important;
    color: #fff !important;
}
.nbd-xlabel-wrapper {
    border-left: 0px!important;
...
span.nbo-delivery-total.ng-binding.ng-scope {
    margin-bottom: -5px;
}
...
.nbd-xlabel-wrapper.vc_row-fluid.count_2 {
    padding-bottom: 0px;
}}
...
.nbd-field-content {
    ...
    .nbd-option-field.three-column .nbd-field-content .nbd-xlabel-wrapper,
    .nbd-option-field.column-three .nbd-field-content .nbd-xlabel-wrapper{
        display: grid;
...
@media (max-width: 767px) and (min-width: 320px) {
  ...
  @media (max-width: 767px) and (min-width: 320px) {
        ...
        .nbd-field-content .nbd-xlabel-wrap{
            margin-bottom: 10px;
        }
    }

    .nbd-option-field.column-two .nbd-field-content .nbd-xlabel-wrapper,
    .nbd-option-field.two-column .nbd-field-content .nbd-xlabel-wrapper,
    .nbd-option-field:not(.three-column):not(.column-three) .nbd-xlabel-wrapper:not(.count_1):not(.count_2):not(.count_3){
        display: grid;
        grid-template-columns: 48% 48%;
        gap: 2.5% 2%;
        padding-bottom: 22px;
    }
    .nbd-option-field.two-column .nbd-field-content .nbd-xlabel-wrapper > div.nbd-xlabel-wrap,
    .nbd-xlabel-wrapper:not(.count_1):not(.count_2):not(.count_3) > div.nbd-xlabel-wrap{
        /* margin-bottom: 50px; */
        padding-bottom: 15px;
    }
    /* .nbd-xlabel-wrapper.vc_row-fluid.count_2{
    ...
    .nbd-xlabel-wrapper.vc_row-fluid.count_3 {
        padding-bottom: 30px;
    }
        @media only screen and (max-width: 767px) and (min-width: 320px){
        .nbd-xlabel-wrapper.vc_row-fluid.count_3 {
    ...
    .nbd-label-wrap input:checked+label{
        border: 2px solid var(--ast-global-color-0) !important;
        transition: all 0.3s;
    }
    .nbd-label-wrap label{
        border: 2px solid transparent !important;
    }

    .nbd-xlabel-wrap.active .nbd-xlabel-value:before {
        content: '';
        width: 100%;
        ...
        left: 0;
        top: 0px;
        border: 3px solid #ECFF8C;
        z-index: 1;
    }
    .elementor-widget-container div.quantity {
        display: none;
    }
   
    .woocommerce-js div.product form.cart  table.nbo-summary-table td {
        padding-left: 8px;
    }
@media (max-width: 767px) and (min-width: 320px) {
        .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .vc_row {
            flex-direction: column;
        }
        .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .vc_row .nbd-xlabel-value{
            /* padding-top: 0 !important */
        }
        .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .vc_row .nbd-xlabel-value .nbd-xlabel-value-inner {
            /* position: relative;
            display: grid;
        ...
        .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .vc_row .nbd-xlabel-value .nbd-xlabel-value-inner h5{
            /* display: flex;
            align-items: center;
            height: 100%;
            padding-left: 8px; */
        ...
        .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .nbd-xlabel-value label.nbd-xlabel{
            background-size: auto 100% !important;
            background-repeat: no-repeat !important;
            background-position: center !important;
            background-color: white !important;
        }
        /* .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .nbd-xlabel-wrapper > div:nth-child(2) .nbd-xlabel-value label.nbd-xlabel {
            background-color: white !important;
        }
        .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .nbd-xlabel-wrapper > div:last-child .nbd-xlabel-value label.nbd-xlabel {
            background-color: #d0fdff !important;
        } */
        /* .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .vc_row .nbd-xlabel-wrap.active .nbd-xlabel-value:before{
            height: 100%;
            max-height:70px;
        }
        .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .vc_row .nbd-xlabel-wrap{
            max-height: 75px;
        }
        .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .vc_row .nbd-xlabel-wrap label.nbd-xlabel{
            background-position: center !important;
            background-size: contain !important;
            min-height: 70px;
        } */
        .nbd-option-field.nbd-field-xlabel-wrap.two.nbo_artwork_action_in_child .nbd-xlabel-wrapper{
            align-items: normal;
        }
    }
@media (max-width: 767px) and (min-width: 320px) {
            ...
            div#overviewbtn a span.overviewText {
                display:none;
            }
            div#coolCardStickyCart .bg-secondary > .cool-row:first-child > .d-flex {
                flex-direction: row;
            }
    ...
    div.active .nbd-xlabel .tooltip.custom,
    div.active .nbd-xlabel .nbd-help-tip{
        background-color: #ECFF8C;
    }
    div.active .nbd-xlabel .tooltip.custom:after,
    div.active .nbd-xlabel .nbd-help-tip:after{
        color: #000;
    }
    ...
    .nbo-table-summary-wrap.nbo-float-summary.nbo-collapse{
        bottom: -90px;
    }
    .d-hide{
        display:none;
    }
    body.nbd-mode-modern .nbd-sidebar #tab-product-template #tab-template .nbd-items-dropdown.template-tags-wrap .main-items .items .item .main-item .item-icon{
        width: 60px;
        height: 60px;
    }
    ...
    .nbo-delivery-wrapper table td, .nbo-delivery-wrapper table th {
        ...
        border-top-color: #5aabbe;
        border-left: 1px solid #5aabbe;
        border-bottom-color: #5aabbe;
    }
    .nbo-delivery-wrapper table td:last-child, .nbo-delivery-wrapper table th:last-child {
        border-right: 1px solid #5aabbe;
    }
    .nbo-delivery-wrapper table tr:last-child td {
        border-bottom: 1px solid #5aabbe;
    }
    .nbo-delivery-wrapper table .nbo-delivery-date-wrap-title {
        background: #5aabbe;
        color: white;
    ...
    .nbd-xlabel-value{padding-top: 50% !important;margin-bottom: 0.75rem !important;}
    ...
    tr:not(.disabled) .nbo-delivery-date-selector.active,
    tr:not(.disabled) .nbo-delivery-date-selector:hover {
        background: #004D4D !important;
        color: #fff !important;
    }
...
@media (max-width: 767px) and (min-width: 320px){
 ...
 @media (max-width: 767px) and (min-width: 320px){
        ...
        .nbo_artwork_action_in_child .nbd-xlabel-wrapper.vc_row-fluid.count_3 {
            gap: 40px;
        }
        .nbd-xlabel-wrapper.vc_row-fluid.count_2 {
            padding-bottom: 22px;
        }
        .nbo_artwork_action_in_child .nbd-xlabel-wrap:hover > label:before{
            /* box-shadow: none; */
        }
        .nbo_artwork_action_in_child .nbd-xlabel-wrap > label:before{
            /* height: auto; */
        }
        /* .nbo_artwork_action_in_child .nbd-xlabel-wrap > label{
            max-height: 70px;
            height: 70px;
        } */
    }
 @media (max-width: 767px) and (min-width: 320px){
    ...
    div.main-popup .nbd-xlabel-wrapper{
        background: transparent;
        box-shadow: none;
    }
    .nbd-xlabel-value-inner h5 {
...
.nbo-delivery .nbd-help-tip, .nbd-field-header .nbd-help-tip {
...
foreach( $options["fields"] as $key => $field ){
    ...
    if( isset($field['nbe_type']) && $field['nbe_type'] == 'actions' && $field['general']['enabled'] == 'y' && isset( $field['general']['attributes'] ) && isset( $field['general']['attributes']["options"] ) && count( $field['general']['attributes']["options"] ) > 0 ){
        ...
        $class .= ' ' . $field['appearance']['css_class'] . ' nbo_artwork_action_in_child';
    }
    ...
    if( $field['general']['data_type'] == 'i' ){
        ...
        if( isset($field['nbd_type']) && ( ( $field['nbd_type'] == 'page' && $field['general']['data_type'] == 'm' ) || ( $field['nbd_type'] == 'page2' ) ) ){
            ...
            $tempalte = $currentDir .'/options-builder/xlabel-shape'.$_prefix.'.php';
        }
        else{
    ...
    if( !( isset( $field['show_in_group'] ) || isset( $field['show_in_popup'] ) ) ){
        if( $field['general']['enabled'] == 'y' && $need_show ){
            include( $tempalte );
        } 
    }
...
if( $cart_item_key != ''){ ?>
        ...
        <div class="nbo-summary-wrapper">
            ...
            <div ng-if="valid_form" class="nbo-collapse nbo-table-summary-wrap <?php echo $style_class; ?> <?php if( !(isset($_REQUEST['wc-api']) && $_REQUEST['wc-api'] == 'NBO_Quick_View') && !$in_quick_view && $float_summary == 'yes' ) echo 'nbo-float-summary'; ?>" <?php if( isset($_REQUEST['wc-api']) && $_REQUEST['wc-api'] == 'NBO_Quick_View' && $nbd_qv_type == '2') echo 'nbd-perfect-scroll'; ?>>
                <p class="nbo-summary-title" ng-init="showNboSummary = true">
                    <span style="font-size: 20px;"><?php _e('Overview', 'web-to-print-online-designer'); ?></span>
                ...
                <table class="nbo-summary-table" ng-show="showNboSummary">
                    <tbody>
                        <tr ng-repeat="(key, field) in nbd_fields" ng-show="field.enable && field.published && field.value_name">
                            <td>{{field.title}}
                            ...
                            <td>
                                <span ng-show="field.value_name">{{field.value_name}}</span> 
                                <!-- <span ng-show="field.value_name && field.price">-</span> 
                                <span ng-show="field.price | to_trusted"><span ng-bind-html="field.price | to_trusted"></span></span> -->
                            </td>
                        </tr>
                    </tbody>
        ...
        <?php do_action( 'nbo_most_bottom_hook'); ?>
    </div>
</div>
<script type="text/javascript">
    (function($){
    ...
    nboApp.controller('optionCtrl', ['$scope', '$timeout', function($scope, $timeout){
        ...
        $scope.show_expert_upload = false;
        ...
        $scope.check_valid = function( calculate_pm, pro, init = false ){
            $timeout(function(){
                ...
                if(typeof $scope.turnaround_quantity_break != 'undefined'){
                    $scope.turnaround_quantity_breaks.forEach((sd, sk) => {
                        $scope.turnaround_quantity_breaks[sk].desabled = false;     
                    });
                }
                angular.forEach($scope.nbd_fields, function(field, field_id){
                    ...
                    // jQuery('.nbd-xlabel-wrap.f1708848691529.wpb_column.vc_column_container.vc_col-sm-12 nbd-xlabel-wrap:first-child')
                    ...
                    var currentOption = origin_field.general.attributes.options;
                    let callinitial = false;
                    let enabled_index = -1;

                    
                    if(typeof NBDESIGNCONFIG != 'undefined' && typeof NBDESIGNCONFIG.selected_orientation != 'undefined' && NBDESIGNCONFIG.selected_orientation){
                        var index = currentOption.findIndex(p => p.name.toLowerCase() == NBDESIGNCONFIG.selected_orientation);
                        
                        if(index > -1){
                            field.value = String(index);

                            jQuery(document.body).find('div[data-id="'+field_id+'"]').hide();
                            let checkedITems = ['vertikal', 'vertical'];

                            setTimeout(() => {
                                if(checkedITems.indexOf(NBDESIGNCONFIG.selected_orientation) > -1){
                                    jQuery(document.body).find('div[data-id="'+field_id+'"]').find('.nbd-xlabel-wrapper > div:last-child label').trigger('click');
                                }else{
                                    jQuery(document.body).find('div[data-id="'+field_id+'"]').find('.nbd-xlabel-wrapper > div:first-child label').trigger('click');
                                }    
                            }, 1000);
                    ...
                    currentOption.forEach((v) => {
                        field.option_value = jQuery(`input[name="nbd-field[${field_id}]"]:checked`).attr('title');
                        if(v.depend && v.name == field.option_value){
                                
                                v.depend.forEach((single) => {
                                    
                                    switch(single.id){
                                        case 'qty':
                                            $scope.row_delivery.push(single);
                                            $scope.turnaround_quantity_breaks.forEach((sd, sk) => {
                                                $scope.turnaround_quantity_breaks[sk].desabled = false; 
                                                ...
                                                switch(single.operator){
                                                    case 'gt':
                                                        ...
                                                        if(single.val > sd.val) $scope.turnaround_quantity_breaks[sk].desabled = true;     
                                                    break;
                                                    case 'lt':
                                                ...
                                                if($scope.turnaround_quantity_breaks[sk].desabled === false) enabled_index = sk;
                                            });
                            ...
                            if( origin_field.nbe_type == 'actions' ){
                                ...
                                if( !( action == 'u' || action == 'c' ) ){
                                    ...
                                    if( ( jQuery('#triggerDesign').length > 0 || jQuery('#startDesign').length > 0 || jQuery('#startUpload').length > 0 ) && angular.isDefined( nbds_frontend ) && nbds_frontend.hide_cart_button == 'yes'){
                                        jQuery('button[type="submit"].single_add_to_cart_button, button#coolCardStickyCart').show();
                                        $scope.show_expert_upload = true;
                                    };
                                }else{
                                    jQuery('#triggerDesign, #startDesign, #startUpload, #useTemplate').show();
                                    // jQuery('#triggerDesign, #useTemplate').show();
                                    if( action == 'u' ){
                                    ...
                                    if( ( jQuery('#triggerDesign').length > 0 || jQuery('#startDesign').length > 0 || jQuery('#startUpload').length > 0 || jQuery('#useTemplate').length > 0 ) && angular.isDefined( nbds_frontend ) && nbds_frontend.hide_cart_button == 'yes'){
                                        jQuery('button[type="submit"].single_add_to_cart_button, button#coolCardStickyCart').hide();
                                        $scope.show_expert_upload = false;
                                    };
                                }
                            }
        ...
        $scope.reset_product_image_attr = function(ele, attr, id){
            jQuery(document).find(ele).attr( attr, $scope.product_image[id][attr] );
        ...
        $scope.checktemplate_url = function(){
            let template_href = jQuery('a#useTemplate').attr('href');
            

            var selected_orientation = 0;
            if(typeof window.nbds_frontend.orientations != 'undefined' 
                && typeof window.nbds_frontend.orientations['horizontal'] != 'undefined'  
                && typeof nbOption.odOption.size != 'undefined' 
                && typeof nbOption.odOption.size.real_height != 'undefined' 
                && nbOption.odOption.size.real_height != nbOption.odOption.size.real_width)
                selected_orientation = window.nbds_frontend.orientations['horizontal'];
            
            if(typeof window.nbds_frontend.orientations != 'undefined' && typeof nbOption.odOption.size != 'undefined' && typeof nbOption.odOption.size.real_height != 'undefined' && nbOption.odOption.size.real_height > nbOption.odOption.size.real_width){
                selected_orientation = window.nbds_frontend.orientations['vertical'] ?? 0;
            }
            template_href = new URL(template_href);
            if(selected_orientation > 0)
                template_href.searchParams.set('orientations', selected_orientation);

            if(jQuery(document.body).hasClass('single-product')){
                template_href.searchParams.set('source', 'single-product');
            }
            jQuery('a#useTemplate').attr('href', template_href.href);
        };
        $scope.change_product_image = function( field_id, option_index ){
            ...
            if( field.appearance.change_image_product == 'y' && field.general.attributes.options[option_index].imagep == 'y' ){
                var slickThumb = jQuery(document.body).find('.slick-list.draggable > .slick-track'),
                mainSliderWrap = jQuery(document.body).find('.wpgs-for.slick-initialized.slick-slider .slick-list .slick-track');


                // jQuery(slickThumb).find('.slick-active').trigger('click', function(){
                    
                // });
                jQuery(mainSliderWrap, slickThumb).css({
                ...
                // setTimeout(function(){
                var product_element = jQuery( 'div.post-'+ $scope.product_id );
                var product_image = product_element.find( '.swiper-slide.swiper-slide-active .wcgs-slider-image img' );
                ...
                var gallery_image = product_element.find( '.gallery-navigation-carousel-wrapper .swiper-slide-thumb-active img' ),
                gallery_wrapper = product_element.find( '.wpgs-nav .slick-track' ),
                product_image_wrap = gallery_wrapper.find( '.slick-slide' ).eq( 0 ).find('img'),
                product_link = product_image.prev( 'a' );
                ...
                if( !option_data.full_src ) option_data.full_src = option_data.image_link;
                    ...
                    if (product_image.length){
                        ...
                        $scope.set_product_image_attr(product_image, 'data-zoom_src', option_data.image_link, 0);

                        $scope.set_product_image_attr(product_image, 'data-o_img', option_data.image_srcset, 0);
                        ...
                        $scope.set_product_image_attr(product_image_wrap, 'src', option_data.image_link, 1);
                    }
                    if (gallery_image.length){
                        $scope.set_product_image_attr(gallery_image, 'src', option_data.image_link, 2);
                        $scope.set_product_image_attr(gallery_image, 'data-image', option_data.image_link, 2);
                    }
        ...
        $scope.init_product_gallery_and_zoom = function(){
            ...
            jQuery( zoom_images ).each( function( index, target ) {
             ...
             //Changed zoom images 
             setTimeout(() => {
                var zoomWindow = jQuery(document.body).find('#netbase-primary-image-ZoomContainer .zoomWindow');
                var imgUrl = '';
                if(jQuery(document.body).find('.featured-gallery .woocommerce-product-gallery__image.swiper-slide.swiper-slide-active > img').length){
                    imgUrl = jQuery(document.body).find('.featured-gallery .woocommerce-product-gallery__image.swiper-slide.swiper-slide-active > img');
                }else{
                    imgUrl = jQuery(document.body).find('.featured-gallery .woocommerce-product-gallery__image.swiper-slide > img');
                }
                jQuery(zoomWindow).css("background-image", `url(${jQuery(imgUrl).attr('src')})`);
             }, 500);
        ...
        $scope.checkAttributeStatus = function( field_id, attr_index, sub_attr_index ){
            ...
            // console.log('current options: ', origin_field);
        ...
        $scope.change_delivery_date = function( qty_break_index, delivery_index ){
            ...
            $scope.total_cart_item_price_num = parseFloat($scope.turnaround_matrix[qty_break_index][delivery_index].total_cart_price.replace('€', ''));
            $scope.custom_quantity = false;
        ...
        $scope.init_price_matrix = function(){
            $scope.options.pm_num_col = 5;
            $scope.options.pm_num_row = 2;
        ...
        $scope.calc_turnaround_matrix = function(){
            ...
            angular.forEach( $scope.turnaround_quantity_breaks, function(_break, key){
                angular.forEach( delivery_field.general.attributes.options, function(op, okey){
                        ...
                        if( field.enable ){
                            ...
                            if( origin_field.general.data_type == 'i' ){
                                ...
                                if(option){ 
                                    ...
                                    // Calculate if delelivery date show or not 
                                    if(option.depend){
                                        
                                        option.depend.forEach(($singledepend) => {
                                            let dependfield = $singledepend.id;
                                            let fieldDetails = $scope.get_field(dependfield);
                                            let targetvalue = nbd_fields[dependfield];

                                            switch($singledepend.operator){
                                                case 'i':
                                                    if($singledepend.val == targetvalue.value){
                                                        $scope.turnaround_matrix[key][okey].show = 'add-false';
                                                    }
                                                break;
                                            }
                                        });
                    ...
                    show = false;
                    if( (op['max_qty'] == '' || max_qty >= qty) &&  $scope.turnaround_matrix[key][okey].show != 'add-false') show = true;
        ...
        $scope.toggle_float_summary = function(){
            ...
            jQuery('#overviewbtn a').toggleClass('nbo-collapse-expended');
        };
        ...
        $scope.update_app = function(){
            if ($scope.$root.$$phase !== "$apply" && $scope.$root.$$phase !== "$digest") $scope.$apply(); 
            jQuery(document.body).find('.nbd-xlabel-value-inner input:checked').closest('.nbd-xlabel-wrap').addClass('active');
        };

        $scope.upload_expert_logo = function(){
            console.log('upload expert logo');
        };
        $scope.init();
    ...
    // Custom Scripts
    jQuery(document).ready(function(){
        jQuery(document.body).on('change', '.nbd-xlabel-value-inner input', function(){
            jQuery(this).closest('.nbd-field-xlabel-wrap').find('.nbd-xlabel-wrap').removeClass('active');
            jQuery(this).closest('.nbd-xlabel-wrap').addClass('active');
        });

        jQuery(document.body).on('click', '.slick-slide.slick-current.slick-active', function(){
            
            var $scope = angular.element(document.getElementById(nbOption.crtlId)).scope();
            var product_element = jQuery( '.post-'+ $scope.product_id );
            var product_image = product_element.find( '.woocommerce-product-gallery__image.single-product-main-image:not(.slick-cloned)' ).eq( 0 ).find( 'img' ).first();
            ...
            $scope.reset_product_image_attr(product_image, 'src', 0);
            // $scope.reset_product_image_attr(product_image, 'srcset', 0);
            $scope.reset_product_image_attr(product_image, 'sizes', 0);
            // $scope.reset_product_image_attr(product_image, 'title', 0);
            // $scope.reset_product_image_attr(product_image, 'alt', 0);
            $scope.reset_product_image_attr(product_image, 'data-src', 0);
            // $scope.reset_product_image_attr(product_image, 'data-large_image', 0); large_image
            $scope.reset_product_image_attr(product_image, 'data-zoom-image', 0);
            // $scope.reset_product_image_attr(product_image, 'data-large_image_width', 0); 
            // $scope.reset_product_image_attr(product_image, 'data-large_image_height', 0);
            $scope.reset_product_image_attr(product_image, 'alt', 0);
