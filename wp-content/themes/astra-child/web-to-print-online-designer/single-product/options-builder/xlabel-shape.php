...
<div nbo-adv-dropdown class="nbd-option-field nbd-field-xlabel-wrap two <?php echo $class; ?> <?php echo isset($field['action']) ? $field['action'] : ''; ?>" data-id="<?php echo $field['id']; ?>" ng-if="nbd_fields['<?php echo $field['id']; ?>'].enable">
