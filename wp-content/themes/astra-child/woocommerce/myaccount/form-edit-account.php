...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide" style="display:none;">
		...
		<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" readonly name="account_username" id="account_username" value="<?php echo esc_attr( $user->data->user_login ); ?>" /> <span><em><?php esc_html_e( 'This will be how your username is. You have no access to customize it.', 'woocommerce' ); ?></em></span>
	<div class="clear"></div>
