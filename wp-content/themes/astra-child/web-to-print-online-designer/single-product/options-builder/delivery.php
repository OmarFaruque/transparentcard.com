            ...
            <thead>
                <tr>
                    <th class="nbo-delivery-icon-wrap" rowspan="2">
                        ...
                        <div class="nbo-delivery-qty"><?php _e('Mengen', 'web-to-print-online-designer'); ?></div>
                    </th>
                    <th class="nbo-delivery-date-wrap-title" colspan="<?php echo count( $delivery_field['general']['attributes']["options"] ); ?>"><div>
                        <?php _e('Druckpreis (exkl. Liefergebühr)', 'web-to-print-online-designer'); ?></div></th>
                </tr>
                <tr>
                    <?php 
