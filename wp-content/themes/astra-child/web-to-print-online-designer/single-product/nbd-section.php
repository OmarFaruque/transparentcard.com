...
<div class="nbdesigner_frontend_container">
    ...
    <?php else: ?>
        ...
        <div class="nbd-action-wrap">
            <?php if( $_enable_upload ): ?>
                ...
                <a class="button alt nbdesign-button upload-design" id="startUpload" style="display:none;">
            ...
            <?php if( $_enable_upload_without_design ): ?>
                ...
                <a class="button alt nbdesign-button start-design" id="startDesign" style="margin-right: 0; display:none;">
                    ...
                    <span><?php esc_html_e( 'Individuelles Design', 'web-to-print-online-designer' ); ?></span>
                </a>
            ...
            <?php //if( $show_button_use_our_template ): ?>
                ...
                <!-- <a class="button alt nbdesign-button start-design" id="useTemplate" href="<?php //echo $template_gallery_url;?>">
                    <span><?php //esc_html_e( 'Process Next', 'web-to-print-online-designer' ); ?></span>
    ...
    <?php endif; ?>
    <p class="heading-4" id="nbdesigner-preview-title" style="display: none;"><?php esc_html_e('Your artwork', 'web-to-print-online-designer'); ?></p>
    ...
    <p class="heading-4" id="nbdesigner-upload-title" style="display: none;"><?php esc_html_e('Upload file', 'web-to-print-online-designer'); ?></p>
