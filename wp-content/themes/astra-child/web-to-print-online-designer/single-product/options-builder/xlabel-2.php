...
<tr nbo-adv-dropdown class="nbd-option-field nbd-field-xlabel-wrap one <?php echo $class; ?>" data-id="<?php echo $field['id']; ?>" ng-if="nbd_fields['<?php echo $field['id']; ?>'].enable">
    <td>
