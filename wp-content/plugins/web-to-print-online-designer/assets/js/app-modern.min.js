    ...
    $scope.insertTemplate = function(local, temp){
        ...
        function loadDesign(fonts, design, viewport, konfig){
            ...
            function loadStage(stageIndex){
                ...
                if( design[_index].backgroundImage != null ) {
                    if(design[_index].backgroundImage.src != undefined && design[_index].backgroundImage.src != null) {
                        scale = stage.states.scaleRange[stage.states.currentScaleIndex].ratio;
                        fabric.Image.fromURL(design[_index].backgroundImage.src, function(op) {
                            var _ratio = 1;
