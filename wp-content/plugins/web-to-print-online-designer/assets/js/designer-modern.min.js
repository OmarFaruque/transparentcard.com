                ...
                $tab.on('click', function () {
                    ...
                    if (checkMobileDevice()) {
                        if ($(this).hasClass('layerTab')) {
                            ...
                            /*NBDesigner Advanced*/
                            if ($(this).attr('id')!='nav-background'){                                    
                                $('.nbd-workspace .tabs-content,.nbd-workspace .main').removeClass('mobile');
                            }else{
                                $('.nbd-workspace .tabs-content,.nbd-workspace .main').addClass('mobile');
                                $('.nbd-workspace .main').addClass('active');
                            }
